"\nThis guide uses a Task Based Approach to satisfy the Payer's need to request the\
  ...
  \ and/or filtered )</span><!-- new-content -->\n- The appropriateness of the request\
  ...
  \ support a claims <span class=\"bg-success\" markdown=\"1\">audit</span><!-- new-content\
  ...
  \ than once every hour after that.</span><!-- new-content -->\n\n#### Subscription\n\
  ...
  1\">recent publication of [FHIR4B](http://hl7.org/fhir/r4b-explanation.html)</span><!--\
  \ new-content --> to address the many shortcomings in the current (R4) approach\
  ...
  \ to support the task based subscriptions framework.</span><!-- new-content -->\n\
  ...
  \ for requesting and receiving provenance using either method are provided below.\
