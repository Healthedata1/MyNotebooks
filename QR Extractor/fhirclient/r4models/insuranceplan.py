...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/InsurancePlan) on 2018-12-20.
...
class InsurancePlanPlanGeneralCost(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  groupSize"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_groupSize", "_groupSize",fhirprimitive.FHIRPrimitive, False, None, False),
            ("type", "type", codeableconcept.CodeableConcept, False, None, False),
        ])
        return js
