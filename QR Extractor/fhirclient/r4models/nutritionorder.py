...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/NutritionOrder) on 2018-12-20.
...
class NutritionOrderEnteralFormula(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  additiveProductName"""
        ...
        """ extension for fhir primitive  administrationInstruction"""
        ...
        """ extension for fhir primitive  baseFormulaProductName"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_additiveProductName", "_additiveProductName",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_administrationInstruction", "_administrationInstruction",fhirprimitive.FHIRPrimitive, False, None, False),
            ("baseFormulaProductName", "baseFormulaProductName", str, False, None, False),
            ("_baseFormulaProductName", "_baseFormulaProductName",fhirprimitive.FHIRPrimitive, False, None, False),
...
class NutritionOrderSupplement(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  productName"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_productName", "_productName",fhirprimitive.FHIRPrimitive, False, None, False),
            ("quantity", "quantity", quantity.Quantity, False, None, False),
            ("schedule", "schedule", timing.Timing, True, None, False),
