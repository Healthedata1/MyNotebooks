...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/CarePlan) on 2018-12-20.
...
class CarePlanActivityDetail(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  scheduledString"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_scheduledString", "_scheduledString",fhirprimitive.FHIRPrimitive, False, None, False),
