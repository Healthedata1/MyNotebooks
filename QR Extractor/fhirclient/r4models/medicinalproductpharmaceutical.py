...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/MedicinalProductPharmaceutical) on 2018-12-20.
...
class MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  supportingInformation"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_supportingInformation", "_supportingInformation",fhirprimitive.FHIRPrimitive, False, None, False),
