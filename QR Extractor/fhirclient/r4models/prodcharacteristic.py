...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/ProdCharacteristic) on 2018-12-20.
...
class ProdCharacteristic(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  imprint"""
        ...
        """ extension for fhir primitive  shape"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_imprint", "_imprint",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_shape", "_shape",fhirprimitive.FHIRPrimitive, False, None, False),
