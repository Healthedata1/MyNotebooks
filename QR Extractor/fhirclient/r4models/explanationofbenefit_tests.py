...
class ExplanationOfBenefitTests(unittest.TestCase):
    ...
    def implExplanationOfBenefit1(self, inst):
        ...
        self.assertEqual(inst.item[0].billcode.coding[0].code, "1205")
        self.assertEqual(inst.item[0].billcode.coding[0].system, "http://terminology.hl7.org/CodeSystem/ex-USCLS")
        ...
        self.assertEqual(inst.payee.resource.code, "organization")
        self.assertEqual(inst.payee.resource.system, "http://terminology.hl7.org/CodeSystem/resource-type-link")
    ...
    def implExplanationOfBenefit2(self, inst):
        ...
        self.assertEqual(inst.form.coding[0].code, "2")
        self.assertEqual(inst.form.coding[0].system, "http://terminology.hl7.org/CodeSystem/forms-codes")
        self.assertEqual(inst.id, "EB3501")
        self.assertEqual(inst.identifier[0].system, "http://www.BenefitsInc.com/fhir/explanationofbenefit")
        self.assertEqual(inst.identifier[0].value, "error-1")
        self.assertEqual(inst.information[0].category.coding[0].code, "employmentimpacted")
        self.assertEqual(inst.information[0].category.coding[0].system, "http://terminology.hl7.org/CodeSystem/claiminformationcategory")
        self.assertEqual(inst.information[0].sequence, 1)
        self.assertEqual(inst.information[0].timingPeriod.end.date, FHIRDate("2014-02-28").date)
        self.assertEqual(inst.information[0].timingPeriod.end.as_json(), "2014-02-28")
        self.assertEqual(inst.information[0].timingPeriod.start.date, FHIRDate("2014-02-14").date)
        self.assertEqual(inst.information[0].timingPeriod.start.as_json(), "2014-02-14")
        self.assertEqual(inst.information[1].category.coding[0].code, "hospitalized")
        self.assertEqual(inst.information[1].category.coding[0].system, "http://terminology.hl7.org/CodeSystem/claiminformationcategory")
        self.assertEqual(inst.information[1].sequence, 2)
        self.assertEqual(inst.information[1].timingPeriod.end.date, FHIRDate("2014-02-16").date)
        self.assertEqual(inst.information[1].timingPeriod.end.as_json(), "2014-02-16")
        self.assertEqual(inst.information[1].timingPeriod.start.date, FHIRDate("2014-02-14").date)
        self.assertEqual(inst.information[1].timingPeriod.start.as_json(), "2014-02-14")
        self.assertTrue(inst.insurance[0].focal)
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://hl7.org/fhir/v3/ActReason")
