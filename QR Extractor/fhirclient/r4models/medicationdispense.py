...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/MedicationDispense) on 2018-12-20.
...
class MedicationDispenseSubstitution(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  wasSubstituted"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_wasSubstituted", "_wasSubstituted",fhirprimitive.FHIRPrimitive, False, None, False),
        ])
        return js
