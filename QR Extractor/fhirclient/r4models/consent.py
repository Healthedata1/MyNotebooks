...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Consent) on 2018-12-20.
...
class ConsentPolicy(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  authority"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_authority", "_authority",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ConsentProvisionData(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  meaning"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_meaning", "_meaning",fhirprimitive.FHIRPrimitive, False, None, False),
            ("reference", "reference", fhirreference.FHIRReference, False, None, True),
        ])
        return js
...
class ConsentVerification(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  verified"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_verified", "_verified",fhirprimitive.FHIRPrimitive, False, None, False),
