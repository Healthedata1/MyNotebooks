...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/SubstanceSourceMaterial) on 2018-12-20.
...
class SubstanceSourceMaterial(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  geographicalLocation"""
        ...
        """ extension for fhir primitive  organismName"""
        ...
        """ extension for fhir primitive  parentSubstanceName"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_geographicalLocation", "_geographicalLocation",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_organismName", "_organismName",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_parentSubstanceName", "_parentSubstanceName",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstanceSourceMaterialFractionDescription(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  fraction"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_fraction", "_fraction",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstanceSourceMaterialOrganism(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  intraspecificDescription"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_intraspecificDescription", "_intraspecificDescription",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstanceSourceMaterialOrganismAuthor(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  authorDescription"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_authorDescription", "_authorDescription",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstanceSourceMaterialOrganismHybrid(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  maternalOrganismId"""
        ...
        """ extension for fhir primitive  maternalOrganismName"""
        ...
        """ extension for fhir primitive  paternalOrganismId"""
        ...
        """ extension for fhir primitive  paternalOrganismName"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_maternalOrganismId", "_maternalOrganismId",fhirprimitive.FHIRPrimitive, False, None, False),
            ("maternalOrganismName", "maternalOrganismName", str, False, None, False),
            ("_maternalOrganismName", "_maternalOrganismName",fhirprimitive.FHIRPrimitive, False, None, False),
            ("paternalOrganismId", "paternalOrganismId", str, False, None, False),
            ("_paternalOrganismId", "_paternalOrganismId",fhirprimitive.FHIRPrimitive, False, None, False),
            ("paternalOrganismName", "paternalOrganismName", str, False, None, False),
            ("_paternalOrganismName", "_paternalOrganismName",fhirprimitive.FHIRPrimitive, False, None, False),
        ])
        return js
