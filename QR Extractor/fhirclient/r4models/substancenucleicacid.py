...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/SubstanceNucleicAcid) on 2018-12-20.
...
class SubstanceNucleicAcid(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  areaOfHybridisation"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_areaOfHybridisation", "_areaOfHybridisation",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstanceNucleicAcidSubunitLinkage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  connectivity"""
        ...
        """ extension for fhir primitive  residueSite"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_connectivity", "_connectivity",fhirprimitive.FHIRPrimitive, False, None, False),
            ("identifier", "identifier", identifier.Identifier, False, None, False),
            ("name", "name", str, False, None, False),
            ("_name", "_name",fhirprimitive.FHIRPrimitive, False, None, False),
            ("residueSite", "residueSite", str, False, None, False),
            ("_residueSite", "_residueSite",fhirprimitive.FHIRPrimitive, False, None, False),
        ])
        return js
