...
class ClaimResponseTests(unittest.TestCase):
    ...
    def implClaimResponse1(self, inst):
        ...
        self.assertEqual(inst.addItem[0].billcode.coding[0].code, "1101")
        self.assertEqual(inst.addItem[0].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        ...
        self.assertEqual(inst.addItem[1].billcode.coding[0].code, "2101")
        self.assertEqual(inst.addItem[1].billcode.coding[0].display, "Radiograph, series (12)")
        self.assertEqual(inst.addItem[1].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
    ...
    def implClaimResponse2(self, inst):
        ...
        self.assertEqual(inst.addItem[1].adjudication[2].category.coding[0].code, "benefit")
        self.assertEqual(inst.addItem[1].billcode.coding[0].code, "2141")
        self.assertEqual(inst.addItem[1].billcode.coding[0].display, "Radiograph, bytewing")
        self.assertEqual(inst.addItem[1].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.addItem[1].itemSequence[0], 1)
        self.assertEqual(inst.addItem[1].net.currency, "USD")
        ...
        self.assertEqual(inst.addItem[2].billcode.coding[0].code, "expense")
        self.assertEqual(inst.addItem[2].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
    ...
    def implClaimResponse5(self, inst):
        ...
        self.assertEqual(inst.item[0].itemSequence, 1)
        self.assertEqual(inst.item[0].noteNumber[0], 1)
        self.assertEqual(inst.item[1].itemSequence, 2)
        self.assertEqual(inst.item[1].noteNumber[0], 1)
        self.assertEqual(inst.item[2].detail[0].detailSequence, 1)
        self.assertEqual(inst.item[2].detail[0].noteNumber[0], 1)
        self.assertEqual(inst.item[2].detail[1].detailSequence, 2)
        self.assertEqual(inst.item[2].detail[1].noteNumber[0], 1)
        self.assertEqual(inst.item[2].itemSequence, 3)
        self.assertEqual(inst.item[2].noteNumber[0], 1)
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://hl7.org/fhir/v3/ActReason")
