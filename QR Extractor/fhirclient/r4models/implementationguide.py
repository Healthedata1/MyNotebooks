...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/ImplementationGuide) on 2018-12-20.
...
class ImplementationGuide(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  license"""
        ...
        """ extension for fhir primitive  packageId"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_license", "_license",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_packageId", "_packageId",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ImplementationGuideDefinitionPage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  generation"""
        ...
        """ extension for fhir primitive  nameUrl"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_generation", "_generation",fhirprimitive.FHIRPrimitive, False, None, False),
            ("nameReference", "nameReference", fhirreference.FHIRReference, False, "name", True),
            ("nameUrl", "nameUrl", str, False, "name", True),
            ("_nameUrl", "_nameUrl",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ImplementationGuideDefinitionResource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  exampleBoolean"""
        ...
        """ extension for fhir primitive  exampleCanonical"""
        ...
        """ extension for fhir primitive  groupingId"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_exampleBoolean", "_exampleBoolean",fhirprimitive.FHIRPrimitive, False, None, False),
            ("exampleCanonical", "exampleCanonical", str, False, "example", False),
            ("_exampleCanonical", "_exampleCanonical",fhirprimitive.FHIRPrimitive, False, None, False),
            ("fhirVersion", "fhirVersion", str, True, None, False),
            ("_fhirVersion", "_fhirVersion",fhirprimitive.FHIRPrimitive, False, None, False),
            ("groupingId", "groupingId", str, False, None, False),
            ("_groupingId", "_groupingId",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ImplementationGuideDefinitionTemplate(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  scope"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_scope", "_scope",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ImplementationGuideManifest(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  image"""
        ...
        """ extension for fhir primitive  other"""
        ...
        """ extension for fhir primitive  rendering"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_image", "_image",fhirprimitive.FHIRPrimitive, False, None, False),
            ("other", "other", str, True, None, False),
            ("_other", "_other",fhirprimitive.FHIRPrimitive, False, None, False),
            ("page", "page", ImplementationGuideManifestPage, True, None, False),
            ("rendering", "rendering", str, False, None, False),
            ("_rendering", "_rendering",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ImplementationGuideManifestPage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  anchor"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_anchor", "_anchor",fhirprimitive.FHIRPrimitive, False, None, False),
            ("name", "name", str, False, None, True),
            ("_name", "_name",fhirprimitive.FHIRPrimitive, False, None, False),
            ("title", "title", str, False, None, False),
            ("_title", "_title",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ImplementationGuideManifestResource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  relativePath"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_relativePath", "_relativePath",fhirprimitive.FHIRPrimitive, False, None, False),
        ])
        return js
