...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/ClinicalImpression) on 2018-12-20.
...
class ClinicalImpression(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  protocol"""
        ...
        """ extension for fhir primitive  summary"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_protocol", "_protocol",fhirprimitive.FHIRPrimitive, False, None, False),
            ("status", "status", str, False, None, True),
            ("_status", "_status",fhirprimitive.FHIRPrimitive, False, None, False),
            ("statusReason", "statusReason", codeableconcept.CodeableConcept, False, None, False),
            ("subject", "subject", fhirreference.FHIRReference, False, None, True),
            ("summary", "summary", str, False, None, False),
            ("_summary", "_summary",fhirprimitive.FHIRPrimitive, False, None, False),
...
class ClinicalImpressionFinding(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  basis"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_basis", "_basis",fhirprimitive.FHIRPrimitive, False, None, False),
