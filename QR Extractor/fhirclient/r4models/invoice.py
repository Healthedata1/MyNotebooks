...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Invoice) on 2018-12-20.
...
class Invoice(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  cancelledReason"""
        ...
        """ extension for fhir primitive  paymentTerms"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_cancelledReason", "_cancelledReason",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_paymentTerms", "_paymentTerms",fhirprimitive.FHIRPrimitive, False, None, False),
...
class InvoiceLineItem(backboneelement.BackboneElement):
    ...
    Each line item represents one charge for goods ond services rendered.
