...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/SubstancePolymer) on 2018-12-20.
...
class SubstancePolymer(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  modification"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_modification", "_modification",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstancePolymerRepeat(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  averageMolecularFormula"""
        ...
        """ extension for fhir primitive  numberOfUnits"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_averageMolecularFormula", "_averageMolecularFormula",fhirprimitive.FHIRPrimitive, False, None, False),
            ("numberOfUnits", "numberOfUnits", int, False, None, False),
            ("_numberOfUnits", "_numberOfUnits",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstancePolymerRepeatRepeatUnit(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  repeatUnit"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_repeatUnit", "_repeatUnit",fhirprimitive.FHIRPrimitive, False, None, False),
