...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/OperationOutcome) on 2018-12-20.
...
class OperationOutcomeIssue(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  diagnostics"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_diagnostics", "_diagnostics",fhirprimitive.FHIRPrimitive, False, None, False),
