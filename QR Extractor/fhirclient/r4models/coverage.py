...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Coverage) on 2018-12-20.
...
class Coverage(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  dependent"""
        ...
        """ extension for fhir primitive  network"""
        ...
        """ extension for fhir primitive  order"""
        ...
        """ extension for fhir primitive  subrogation"""
        ...
        """ extension for fhir primitive  subscriberId"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_dependent", "_dependent",fhirprimitive.FHIRPrimitive, False, None, False),
            ("identifier", "identifier", identifier.Identifier, True, None, False),
            ("network", "network", str, False, None, False),
            ("_network", "_network",fhirprimitive.FHIRPrimitive, False, None, False),
            ("order", "order", int, False, None, False),
            ("_order", "_order",fhirprimitive.FHIRPrimitive, False, None, False),
            ...
            ("_subrogation", "_subrogation",fhirprimitive.FHIRPrimitive, False, None, False),
            ("subscriber", "subscriber", fhirreference.FHIRReference, False, None, False),
            ("subscriberId", "subscriberId", str, False, None, False),
            ("_subscriberId", "_subscriberId",fhirprimitive.FHIRPrimitive, False, None, False),
