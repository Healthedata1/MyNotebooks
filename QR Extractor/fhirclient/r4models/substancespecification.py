...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/SubstanceSpecification) on 2018-12-20.
...
class SubstanceSpecificationMoiety(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  amountString"""
        ...
        """ extension for fhir primitive  molecularFormula"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_amountString", "_amountString",fhirprimitive.FHIRPrimitive, False, None, False),
            ("identifier", "identifier", identifier.Identifier, False, None, False),
            ("molecularFormula", "molecularFormula", str, False, None, False),
            ("_molecularFormula", "_molecularFormula",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstanceSpecificationProperty(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  parameters"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_parameters", "_parameters",fhirprimitive.FHIRPrimitive, False, None, False),
        ])
        return js
...
class SubstanceSpecificationRelationship(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  isDefining"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_isDefining", "_isDefining",fhirprimitive.FHIRPrimitive, False, None, False),
...
class SubstanceSpecificationStructure(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  molecularFormulaByMoiety"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_molecularFormulaByMoiety", "_molecularFormulaByMoiety",fhirprimitive.FHIRPrimitive, False, None, False),
