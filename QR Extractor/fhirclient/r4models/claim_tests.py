...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(inst.information[0].timingPeriod.end.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.information[0].timingPeriod.end.as_json(), "2014-08-16")
        self.assertEqual(inst.information[0].timingPeriod.start.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.information[0].timingPeriod.start.as_json(), "2014-08-16")
        ...
        self.assertEqual(inst.information[1].timingPeriod.end.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.information[1].timingPeriod.end.as_json(), "2014-08-16")
        self.assertEqual(inst.information[1].timingPeriod.start.date, FHIRDate("2014-08-15").date)
        self.assertEqual(inst.information[1].timingPeriod.start.as_json(), "2014-08-15")
        ...
        self.assertEqual(inst.item[0].billcode.coding[0].code, "exam")
        self.assertEqual(inst.item[0].billcode.coding[0].system, "http://hl7.org/fhir/ex-serviceproduct")
    ...
    def implClaim3(self, inst):
        ...
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].billcode.coding[0].code, "1200")
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
        self.assertEqual(inst.item[0].net.currency, "USD")
    ...
    def implClaim4(self, inst):
        ...
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].billcode.coding[0].code, "exam")
        self.assertEqual(inst.item[0].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
        self.assertEqual(inst.item[0].net.currency, "USD")
    ...
    def implClaim5(self, inst):
        ...
        self.assertEqual(inst.item[0].billcode.coding[0].code, "glasses")
        self.assertEqual(inst.item[0].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
        ...
        self.assertEqual(inst.item[0].detail[0].billcode.coding[0].code, "frame")
        self.assertEqual(inst.item[0].detail[0].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
        ...
        self.assertEqual(inst.item[0].detail[1].billcode.coding[0].code, "lens")
        self.assertEqual(inst.item[0].detail[1].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[0].billcode.coding[0].code, "lens")
        self.assertEqual(inst.item[0].detail[1].subDetail[0].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[1].billcode.coding[0].code, "hardening")
        self.assertEqual(inst.item[0].detail[1].subDetail[1].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
        ...
        self.assertEqual(inst.item[0].detail[1].subDetail[2].billcode.coding[0].code, "UV coating")
        self.assertEqual(inst.item[0].detail[1].subDetail[2].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
        ...
        self.assertEqual(inst.item[0].detail[2].billcode.coding[0].code, "fst")
        self.assertEqual(inst.item[0].detail[2].billcode.coding[0].system, "http://example.org/fhir/CodeSystem/ex-visionservice")
    ...
    def implClaim8(self, inst):
        ...
        self.assertEqual(inst.information[0].code.coding[0].system, "http://example.org/fhir/CodeSystem/pharmacy-refill")
        self.assertEqual(inst.information[0].sequence, 1)
        ...
        self.assertEqual(inst.information[1].code.coding[0].system, "http://example.org/fhir/CodeSystem/pharmacy-information")
        self.assertEqual(inst.information[1].sequence, 2)
        ...
        self.assertEqual(inst.information[2].code.coding[0].system, "http://example.org/fhir/CodeSystem/pharmacy-information")
        self.assertEqual(inst.information[2].sequence, 3)
        self.assertEqual(inst.information[2].valueQuantity.value, 90)
        self.assertTrue(inst.insurance[0].focal)
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].billcode.coding[0].code, "562721")
        self.assertEqual(inst.item[0].billcode.coding[0].display, "Alprazolam 0.25mg (Xanax)")
        self.assertEqual(inst.item[0].billcode.coding[0].system, "http://www.nlm.nih.gov/research/umls/rxnorm")
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
        self.assertEqual(inst.item[0].detail[0].billcode.coding[0].code, "drugcost")
        self.assertEqual(inst.item[0].detail[0].billcode.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[0].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[0].net.value, 45.0)
        self.assertEqual(inst.item[0].detail[0].sequence, 1)
        self.assertEqual(inst.item[0].detail[1].billcode.coding[0].code, "markup")
        self.assertEqual(inst.item[0].detail[1].billcode.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[1].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[1].net.value, 9.0)
        self.assertEqual(inst.item[0].detail[1].sequence, 2)
        self.assertEqual(inst.item[0].detail[2].billcode.coding[0].code, "dispensefee")
        self.assertEqual(inst.item[0].detail[2].billcode.coding[0].system, "http://hl7.org/fhir/ex-pharmaservice")
        self.assertEqual(inst.item[0].detail[2].net.currency, "USD")
    ...
    def implClaim9(self, inst):
        ...
        self.assertTrue(inst.insurance[0].focal)
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].billcode.coding[0].code, "ORTHPLAN")
        self.assertEqual(inst.item[0].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
        self.assertEqual(inst.item[0].detail[0].billcode.coding[0].code, "ORTHOEXAM")
        self.assertEqual(inst.item[0].detail[0].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.item[0].detail[0].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[0].net.value, 1000.0)
        self.assertEqual(inst.item[0].detail[0].sequence, 1)
        self.assertEqual(inst.item[0].detail[0].unitPrice.currency, "USD")
        self.assertEqual(inst.item[0].detail[0].unitPrice.value, 1000.0)
        self.assertEqual(inst.item[0].detail[1].billcode.coding[0].code, "ORTHODIAG")
        self.assertEqual(inst.item[0].detail[1].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.item[0].detail[1].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[1].net.value, 1500.0)
        self.assertEqual(inst.item[0].detail[1].sequence, 2)
        self.assertEqual(inst.item[0].detail[1].unitPrice.currency, "USD")
        self.assertEqual(inst.item[0].detail[1].unitPrice.value, 1500.0)
        self.assertEqual(inst.item[0].detail[2].billcode.coding[0].code, "ORTHOINITIAL")
        self.assertEqual(inst.item[0].detail[2].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.item[0].detail[2].net.currency, "USD")
        self.assertEqual(inst.item[0].detail[2].net.value, 500.0)
        self.assertEqual(inst.item[0].detail[2].sequence, 3)
        self.assertEqual(inst.item[0].detail[2].unitPrice.currency, "USD")
        self.assertEqual(inst.item[0].detail[2].unitPrice.value, 500.0)
        self.assertEqual(inst.item[0].detail[3].billcode.coding[0].code, "ORTHOMONTHS")
        self.assertEqual(inst.item[0].detail[3].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        self.assertEqual(inst.item[0].detail[3].quantity.value, 24)
        self.assertEqual(inst.item[0].detail[3].sequence, 4)
        self.assertEqual(inst.item[0].detail[4].billcode.coding[0].code, "ORTHOPERIODIC")
        self.assertEqual(inst.item[0].detail[4].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        ...
        self.assertEqual(inst.item[1].billcode.coding[0].code, "21211")
        self.assertEqual(inst.item[1].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        ...
        self.assertEqual(inst.item[2].billcode.coding[0].code, "27211")
        self.assertEqual(inst.item[2].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        ...
        self.assertEqual(inst.item[2].detail[0].billcode.coding[0].code, "27211")
        self.assertEqual(inst.item[2].detail[0].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
        ...
        self.assertEqual(inst.item[2].detail[1].billcode.coding[0].code, "lab")
        self.assertEqual(inst.item[2].detail[1].billcode.coding[0].system, "http://example.org/fhir/oralservicecodes")
    ...
    def implClaim10(self, inst):
        ...
        self.assertEqual(inst.information[0].category.coding[0].code, "hospitalized")
        self.assertEqual(inst.information[0].category.coding[0].system, "http://terminology.hl7.org/CodeSystem/claiminformationcategory")
        self.assertEqual(inst.information[0].sequence, 1)
        self.assertEqual(inst.information[0].timingPeriod.end.date, FHIRDate("2015-10-05T00:00:00-07:00").date)
        self.assertEqual(inst.information[0].timingPeriod.end.as_json(), "2015-10-05T00:00:00-07:00")
        self.assertEqual(inst.information[0].timingPeriod.start.date, FHIRDate("2015-10-01T00:00:00-07:00").date)
        self.assertEqual(inst.information[0].timingPeriod.start.as_json(), "2015-10-01T00:00:00-07:00")
        self.assertEqual(inst.information[1].category.coding[0].code, "discharge")
        self.assertEqual(inst.information[1].category.coding[0].system, "http://terminology.hl7.org/CodeSystem/claiminformationcategory")
        self.assertEqual(inst.information[1].code.coding[0].code, "01")
        self.assertEqual(inst.information[1].code.coding[0].display, "Discharge to Home or Self Care")
        self.assertEqual(inst.information[1].code.coding[0].system, "https://www.cms.gov/Outreach-and-Education/Medicare-Learning-Network-MLN/MLNMattersArticles/downloads/SE0801.pdf")
        self.assertEqual(inst.information[1].sequence, 2)
        self.assertTrue(inst.insurance[0].focal)
        ...
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].billcode.coding[0].code, "62264")
        self.assertEqual(inst.item[0].billcode.coding[0].display, "Surgical Procedures on the Spine and Spinal Cord")
        self.assertEqual(inst.item[0].billcode.coding[0].system, "http://www.ama-assn.org/go/cpt")
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
