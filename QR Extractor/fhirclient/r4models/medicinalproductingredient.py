...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/MedicinalProductIngredient) on 2018-12-20.
...
class MedicinalProductIngredientSpecifiedSubstanceStrength(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  measurementPoint"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_measurementPoint", "_measurementPoint",fhirprimitive.FHIRPrimitive, False, None, False),
