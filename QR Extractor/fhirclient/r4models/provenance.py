...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.6.0-bd605d07 (http://hl7.org/fhir/StructureDefinition/Provenance) on 2018-12-20.
...
class ProvenanceEntity(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        """ extension for fhir primitive  role"""
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("_role", "_role",fhirprimitive.FHIRPrimitive, False, None, False),
